...
<title>Vòng Quay Lì Xì May Mắn</title>
...
const prizes=[
 ...
 {name:"200K",weight:0},
 {name:"500K",weight:0},
 {name:"❤️ nhỏ bé của Phúc",weight:100},
 {name:"1 Triệu",weight:0}
];
...
lixiImage.onclick=function(){
 ...
 // 1️⃣ hiện hình mở trước
 lixiImage.src="images/lixi_open.png";

 // 2️⃣ sau 500ms tạo pháo hoa
 setTimeout(()=>{
   for(let i=0;i<20;i++){
     createFirework();
   }
